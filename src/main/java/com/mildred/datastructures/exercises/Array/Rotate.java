...
public class Rotate {
    /**
     * This method rotates an array to the right by k steps, where k is a non-negative integer.
     * @param nums
     * @param k
     */
    ...
    public static void main(String[] args) {
        ...
        int k6 = 6;
        rotate(nums6, k6);
        System.out.println("Test case 5: Rotated array: " + Arrays.toString(nums6));  // prints "Rotated array: [1, 2, 3, 4, 5, 6]"
