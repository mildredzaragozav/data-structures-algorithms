...
public class SortedArraytoBST {
    ...
    /**
     * This method takes a sorted array of integers (nums) as input and constructs a height-balanced BST.
     * left and right denotes the current segment of the array being processed.
     * @param nums: Sorted array of integers.
     * @param left: Starting index for the current segment of the array
     * @param right: Ending index for the current segment of the array
     * @return
     */
