package com.mildred.datastructures.exercises.Heap;

import com.mildred.datastructures.Heap;
...
public class MaximumElementInAStream {
    ...
    /**
     * This method processes a stream of integers and returns the maximum number encountered so far for each input number.
     * @param nums
     * @return
     */
    public static List<Integer> streamMax(int[] nums) {
        ...
        for (int n : nums) {
            myHeap.insert(n);
            myList.add(myHeap.getHeap().get(0));
        }
